...
const getRecipe = async function() {
    try {
        ...
        (0, _bookmarksViewsJsDefault.default).update(_modelJs.state.bookmarks);
...
function servingControl(newservings) {
    _modelJs.updatenewServing(newservings);
...
function init() {
    ...
    (0, _recipeViewJsDefault.default).addHandleBookmark(controlBookmark);
    (0, _bookmarksViewsJsDefault.default).addHandler(controlRenderBookmark);
    ...
    (0, _recipeViewJsDefault.default).addHandlerServing(servingControl);
}
init();

},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","url:../img/icons.svg":"fd0vu","regenerator-runtime/runtime":"f6ot0","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/paginationView.js":"7NIiB","./views/bookmarksViews.js":"ifyyU","./views/addRecipeView.js":"8AWnP","../js/config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "updatenewServing", ()=>updatenewServing);
parcelHelpers.export(exports, "storeBookmark", ()=>storeBookmark);
...
const state = {
    ...
    search: {
        ...
        result: [],
        page: 1,
        resultPerPage: (0, _config.RES_PAGE)
    },
    bookmarks: []
};
const loadRecipe = async function(id) {
    try {
        const res = await (0, _helper.getJSON)(`${(0, _config.API_URL)}/${id}?key=${(0, _config.API_KEY)}`);
        state.recipe = res.data.recipe;
        if (state.bookmarks.some((d)=>d.id == state.recipe.id)) state.recipe.bookmark = true;
...
const searchRecipe = async function(keyword) {
    try {
        ...
        const res = await (0, _helper.getJSON)(`${(0, _config.API_URL)}?search=${keyword}&key=${(0, _config.API_KEY)}`);
        console.log(res);
...
const updatenewServing = function(newservings) {
...
const addRecipe = async function(newrecipe) {
    try {
        const ingredients = Object.entries(newrecipe).filter((d)=>d[0].startsWith("ingredient") && d[1].trim() !== '').map((d)=>{
            ...
            if (arr.length != 3) throw new Error("Invalid Input, Please use correct format");
        ...
        const data = await (0, _helper.sendJSON)(`${(0, _config.API_URL)}?key=${(0, _config.API_KEY)}`, newobj);
        console.log(data);
...
const API_KEY = 'cbc2d556-1338-435e-b5dd-ffdcc74ad83c';
const timeout_sec = 5;
const RES_PAGE = 10;
...
const sendJSON = async function(url, reqdata) {
    try {
...
},{"./config":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
class ReciepeView extends (0, _viewDefault.default) {
...
},{"url:../../img/icons.svg":"fd0vu","fraction.js":"md6n5","./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!newEl.isEqualNode(currEle) && newEl.firstChild?.nodeValue.trim() != '') currEle.textContent = newEl.textContent;
            if (!newEl.isEqualNode(currEle)) Array.from(newEl.attributes).forEach((data)=>{
...
class ResultView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        return this._data.map((data)=>(0, _previewViewDefault.default).render(data, false)).join('');
    }
}
...
},{"url:../../img/icons.svg":"fd0vu","fraction.js":"md6n5","./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NIiB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ifyyU":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class bookMarks extends (0, _viewDefault.default) {
...
},{"url:../../img/icons.svg":"fd0vu","fraction.js":"md6n5","./previewView":"6tKHS","./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
